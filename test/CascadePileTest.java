...
/**
 * Class for testing cascade piles.
 */
public class CascadePileTest {
  ...
  //that does not follow the build for a cascade pile
  @Test(expected = IllegalArgumentException.class)
  public void testGameAddInvalidBuild() {
    Pile<Card> pileFrom = new CascadePile();
    pile.add(new Card(CardValue.TWO, Suit.DIAMONDS));
    pile.gameAdd(new Card(CardValue.ACE, Suit.HEARTS), pileFrom);
  }

  //tests that the gameAdd method correctly adds a card to the pile for valid cascade pile builds
  @Test
  public void testGameAddValidBuild() {
    Pile<Card> pileFrom = new CascadePile();
    pile.add(new Card(CardValue.TWO, Suit.DIAMONDS));
    pile.gameAdd(new Card(CardValue.ACE, Suit.SPADES), pileFrom);
